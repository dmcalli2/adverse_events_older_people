...
data for people in Wales. From among our existing cohort of people with
hypertension identified via primary care Read codes described previously
(<https://bmcmedicine.biomedcentral.com/articles/10.1186/s12916-019-1427-1>),
we will exclude any patient who has not received a treatment with any
drug in the RAAS class, and those with recent myocardial infarction,
stroke or TIA (to attempt to exclude patients started on these drugs for
...
repeat the modelling without these exclusions.
